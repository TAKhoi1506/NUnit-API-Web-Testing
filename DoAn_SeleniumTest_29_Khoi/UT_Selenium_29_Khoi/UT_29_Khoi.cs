...
namespace UT_Selenium_29_Khoi
{
    [TestClass]
    public class UT_29_Khoi
    {

        //Truyền key là "đau đầu" -> Pass
        [TestMethod]
        public void TC01_AddProductToCart_29_Khoi_Pass()
        {
            ...
            Assert.IsTrue(soLuongSP_29_Khoi && !khongtimThay_29_Khoi, "Không có sản phẩm nào được thêm vào");
        ...
        //Truyền key là "đau bụng" -> Không có sản phầm trong giỏ hàng -> Fail
        [TestMethod]
        public void TC02_AddProductToCart_29_Khoi_Fail()
        {
            //Khởi tạo webdriver mới là 1 driver chuyên dùng cho trình duyệt chrome
            IWebDriver driver_29_Khoi = new ChromeDriver();
            ...
            //Tìm thanh tìm kiếm trên trang web và nhập từ khóa là "đau bụng"
            IWebElement timKiem_29_Khoi = driver_29_Khoi.FindElement(By.XPath("//*[@id=\"__next\"]/div[1]/header/div/div[2]/div/div/div[4]/div/div/div/form/input"));
            timKiem_29_Khoi.SendKeys("đau bụng");
            Thread.Sleep(1000);//Đợi 1 giây để trình duyệt kịp xử lý
        ...
        //Truyền file ảnh ra kết quả dúng
        [TestMethod]
        public void TC03_UploadImageSearch_29_Khoi_Pass()
        {
            ...
            try
            {
                ...
                // Kiểm tra kết quả
                Assert.IsTrue(results_29_Khoi.Count > 0, "Không tìm thấy sản phẩm nào phù hợp.");
            ...
            {
                Assert.Fail("Danh sách kết quả không hiển thị.");
            }
            finally
            {
        ...
        //Truyền file ảnh ra không ra kết quả
        [TestMethod]
        public void TC04_UploadImageSearch_29_Khoi_Fail()
        {
            //Khởi tạo đối tượng WebDriver sử dụng trình duyệt Chrome
            IWebDriver driver_29_Khoi = new ChromeDriver();
            try
            {
                ...
                //Gửi đường dẫn ảnh trực tiếp vào input(giả lập người dùng chọn ảnh từ máy)
                uploadInput_29_Khoi.SendKeys("D:\\OU\\HK8\\KTPM\\Image\\panadol.jpg");
                Thread.Sleep(3000); //Đợi hệ thống nhận diện ảnh
        ...
        //Truyền nhiều ảnh
        [TestMethod]
        public void TC05_UploadImagesSearch_29_Khoi_Pass()
        {
            //Khởi tạo đối tượng WebDriver sử dụng trình duyệt Chrome
            IWebDriver driver_29_Khoi = new ChromeDriver();
            try
            {
                ...
                //Dùng "+" và "\n" để dẫn nhiều đường dẫn ảnh trực tiếp vào input(giả lập người dùng chọn ảnh từ máy)
                //Gửi 2 ảnh từ máy
                uploadInput_29_Khoi.SendKeys("D:\\OU\\HK8\\KTPM\\Image\\panadol.jpg" + "\n" + "D:\\OU\\HK8\\KTPM\\Image\\eugica.jpg");
                Thread.Sleep(3000); //Đợi hệ thống nhận diện ảnh
        ...
        //Truyền ảnh quá số lượng -> gửi 6 ảnh từ máy
        [TestMethod]
        public void TC06_UploadImagesSearch_29_Khoi_Fail()
        {
            IWebDriver driver_29_Khoi = new ChromeDriver();
            try
            {
            ...
            {
                Assert.Fail("Upload ảnh quá số lượng");
            }
            catch (NoSuchElementException)
            {
                Assert.Fail("Danh sách kết quả không hiển thị.");
        ...
        // Giá bán: dưới 100.000đ
        // Loại thuốc: chọn cả "Thuốc kê đơn" và "Thuốc không kê đơn"
        // Nước sản xuất: tìm và chọn "Ấn Độ"
        // Chỉ định: mở rộng và chọn "Viêm họng"
        // Kết quả -> Hiển thị 1 sản phẩm -> Pass
        [TestMethod]
        public void TC07_AdvancedFilterSearch_29_Khoi_Pass()
        {
            ...
            try
            {
                ...
                // Kiểm tra kết quả có hiển thị không
                ...
                Assert.IsTrue(ketQua_29_Khoi.Count > 0, "Không tìm thấy sản phẩm sau khi áp dụng bộ lọc.");

                Console.WriteLine($"✅ Tìm thấy {ketQua_29_Khoi.Count} sản phẩm sau khi lọc.");
            }
            catch (NoSuchElementException ex)
            {
                Assert.Fail("❌ Có lỗi xảy ra khi chạy bộ lọc nâng cao: " + ex.Message);
            }
            finally
            {
                Thread.Sleep(3000);
        ...
        // Loại thuốc: chọn cả "Thuốc kê đơn" và "Thuốc không kê đơn"
        // Nước sản xuất: tìm và chọn "Ấn Độ"
        // Chỉ định: mở rộng và chọn "Viêm Khớp"
        // Kết quả -> Không Hiển thị sản phẩm -> Fail
        [TestMethod]
        public void TC08_AdvancedFilterSearch_29_Khoi_Fail()
        {
            // Khởi tạo WebDriver với trình duyệt Chrome
            IWebDriver driver_29_Khoi = new ChromeDriver();
            ...
            try
            {
                ...
                xemThem_29_Khoi.Click(); // Mở rộng danh sách chỉ định
                driver_29_Khoi.FindElement(By.XPath("//label[span[text() = 'Viêm khớp']]")).Click();
                Thread.Sleep(3000);
